...
function startup_revolution_scripts() {
    ...
    wp_enqueue_style( 'startup-revolution-style', get_template_directory_uri() . '/css/style.css');
    ...
    wp_enqueue_script( 'startup-revolution-scripts', get_template_directory_uri() . '/js/startup.js', array( ), '', false );
