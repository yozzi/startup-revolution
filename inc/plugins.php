...
function startup_reloaded_register_required_plugins() {
    ...
    $config = array(
        ...
        'strings'      => array(
            'page_title'                      => __( 'Additional Plugins', 'startup-revolution' ),
            'menu_title'                      => __( 'Plugins', 'startup-revolution' ),
            'installing'                      => __( 'Installing Plugin: %s', 'startup-revolution' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'startup-revolution' ),
            'notice_can_install_required'     => _n_noop( 'This theme requires the following plugin: %1$s.', 'This theme requires the following plugins: %1$s.', 'startup-revolution'),
            'notice_can_install_recommended'  => _n_noop( 'This theme recommends the following plugin: %1$s.', 'This theme recommends the following plugins: %1$s.', 'startup-revolution'),
            'notice_cannot_install'           => _n_noop( 'Sorry, but you do not have the correct permissions to install the %s plugin. Contact the administrator of this site for help on getting the plugin installed.', 'Sorry, but you do not have the correct permissions to install the %s plugins. Contact the administrator of this site for help on getting the plugins installed.', 'startup-revolution'),
            'notice_can_activate_required'    => _n_noop( 'The following required plugin is currently inactive: %1$s.', 'The following required plugins are currently inactive: %1$s.', 'startup-revolution'),
            'notice_can_activate_recommended' => _n_noop( 'The following recommended plugin is currently inactive: %1$s.', 'The following recommended plugins are currently inactive: %1$s.', 'startup-revolution'),
            'notice_cannot_activate'          => _n_noop( 'Sorry, but you do not have the correct permissions to activate the %s plugin. Contact the administrator of this site for help on getting the plugin activated.', 'Sorry, but you do not have the correct permissions to activate the %s plugins. Contact the administrator of this site for help on getting the plugins activated.', 'startup-revolution'),
            'notice_ask_to_update'            => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with this theme: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with this theme: %1$s.', 'startup-revolution'),
            ...
            'install_link'                    => _n_noop( 'Begin installing plugin', 'Begin installing plugins', 'startup-revolution'),
            'activate_link'                   => _n_noop( 'Begin activating plugin', 'Begin activating plugins', 'startup-revolution'),
            'return'                          => __( 'Return to Required Plugins Installer', 'startup-revolution' ),
            'plugin_activated'                => __( 'Plugin activated successfully.', 'startup-revolution' ),
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'startup-revolution' ), // %s = dashboard link.
