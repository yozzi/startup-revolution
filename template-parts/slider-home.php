                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="carousel-content <?php if ( $position ) { echo $position; } ?>">
                                            <h2 class="hvr-grow" data-animation="animated <?php echo $title_animation ?>" style="-webkit-animation-delay: <?php echo $title_delay ?>ms;-moz-animation-delay: <?php echo $title_delay ?>ms;animation-delay: <?php echo $title_delay ?>ms;">
                                                <?php echo $slider->post_title ?>
                                            </h2>
                                            <?php if( $slider->post_content ) { ?>
                                            <br />
                                            <p class="hvr-grow" data-animation="animated <?php echo $content_animation ?>" style="-webkit-animation-delay: <?php echo $content_delay ?>ms;-moz-animation-delay: <?php echo $content_delay ?>ms;animation-delay: <?php echo $content_delay ?>ms;">
