                ...
                <div class="col-xs-12">
                    <form class="navbar-form"> 
                        ...
                        <div class="input-group tools">  
                            <a href="mailto:?subject=Croisi&egrave;res AML : <?php echo get_the_title(); ?>&body=<?php _e( 'Hi, here is the link for the page', 'startup-revolution' ) ?> <?php echo get_the_title(); ?> : <?php echo get_permalink(); ?>" class="btn btn-default" target=_blank><i class="fa fa-envelope" aria-hidden="true"></i></a>
